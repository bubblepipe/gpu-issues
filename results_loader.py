...
import sys
from cates import (
    IsReallyBug, UserPerspective, DeveloperPerspective, AcceleratorSpecific,
    IS_REALLY_BUG_LOOKUP, USER_PERSPECTIVE_LOOKUP, 
    DEVELOPER_PERSPECTIVE_LOOKUP, ACCELERATOR_SPECIFIC_LOOKUP
)
...
def load_categorized_json_files(pattern):
    ...
    Returns:
        ...
        developer_perspective, accelerator_specific
    """
    all_issues = []
    result_files = glob.glob(pattern)
